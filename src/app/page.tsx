    ...
    <div className="bg-black min-h-screen w-full">
      ...
      <div className="px-8 lg:px-26 lg:py-0">
        ...
        <p className="w-full py-6 text-center mt-8 mb-8 text-white leading-relaxed text-xl lg:text-2xl font-special-elite">
          ...
          with the intimacy of a speakeasy and the charm of the Old West.
          Whether Carson City is your home or you are traveling through, our
          doors are open to anyone seeking a distinctive experience built on
          quality, creativity, and community. Step inside and share a
          drink&mdash;and a story&mdash;in a space where everyone is welcome and
          every visit adds to the history.
        </p>
